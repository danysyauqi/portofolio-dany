    ...
    <section className='lg:py-16'>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className='text-[#ADB7BE] text-left sm:text-lg mb-10 lg:text-xl'>
            North Jakarta, DKI Jakarta
          </p>
          <div>
            <Link href="https://www.linkedin.com/in/danysyauqi/"
              className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#0077b5] hover:bg-[#00A0DC] text-white'>
              Connect Me
            </Link>
            <Link href="https://github.com/danysyauqi"
              className='px-6 py-3 w-full sm:w-fit rounded-full bg-gradient-to-bl from-transparent via-gray-800 to-gray-800 hover:bg-slate-800 text-white border border-gray-800 mt-3'>
              GitHub
            </Link>
          </div>
        </motion.div>
